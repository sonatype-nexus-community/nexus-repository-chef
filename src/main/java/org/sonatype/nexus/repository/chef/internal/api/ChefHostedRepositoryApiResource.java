...
public abstract class ChefHostedRepositoryApiResource
        extends AbstractHostedRepositoriesApiResource<ChefHostedApiRepositoryRequest> {
    @ApiOperation("Create chef supermarket hosted repository")
    @ApiResponses(value = {
    ...
    @Validate
    @Override
    public Response createRepository(ChefHostedApiRepositoryRequest request) {
        return super.createRepository(request);
    }

    @ApiOperation("Update chef supermarket hosted repository")
    @ApiResponses(value = {
    ...
    public Response updateRepository(
            final ChefHostedApiRepositoryRequest request,
